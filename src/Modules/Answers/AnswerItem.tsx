import { IAnswerItem, IItemComponentProps, SetItemVal } from '../../types'
...
const AnswerItem: FC<IItemComponentProps<T>> = props => {
	const [answer, setVal] = useItemActions<T>(props.save, props.item, ['text', 'answer'])
	...
	return (
		<tr className={answer.active ? '' : 'grey-text text-lighten-1'}>
			...
			<Text
				...
				onBlur={(e: FocusEvent<HTMLInputElement>) => change('answer', e.target.value)}
			/>
			<Chips
